                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 10,),  //مسئولة عن ابعاد كلمة اتحاد الملاك و تنزياها اسف و اعلي في نفس الوضع الراسي
                      Row(
                        children: [
                          Expanded(
                            child: Container(
          ...
          /*SiContainer(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('${AppLocalizations.of(context)!.translate("pass_hint").toString()} ',  // جملة يمكنك الحصول علي كلمة المرور من إتحاد الملاك
                       // AppLocalizations.of(context)!.translate("Comp_Name").toString(),
                       style: TextStyle(color: Color(0xffe72d0c),fontSize: 25,height: 0.3,fontFamily: 'NotoSansArabic') ,  // مسئولة عن تنزيل احصل علي كلمة المرور و كل اللي تحت -- الي اسفل او اعلي
                        textAlign: TextAlign.right,
                      ),
